...
//we had:  l1.isSameLengthAs(l3));
//compares the lengths of adjacent sides, l1 and l2. This comparison ensures that opposite sides of the quadrilateral are equal, which is a defining characteristic of a square.